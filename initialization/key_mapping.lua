...
g_keymap.set('n', '<Leader>tl', ':ls<CR>', g_default_opts)
...
g_keymap.set('n', '<M-Down>', '<C-w>p<C-e><C-w>p')
g_keymap.set('n', '<M-Up>', '<C-w>p<C-y><C-w>p')
g_keymap.set('i', '<M-Down>', '<Esc><C-w>p<C-e><C-w>pi')
g_keymap.set('i', '<M-Up>', '<Esc><C-w>p<C-y><C-w>pi')
